...
class MakeShare(forms.Form):
    ...
    networks = forms.MultipleChoiceField(
        ...
        widget=CheckboxSelectMultiple, label=_("Select Networks"))
    title = forms.CharField(max_length=120, 
        min_length=10, label=_("Title"),
        help_text=_("The title or headline for your share"))
    excerpt = froms.CharField(max_length=200, min_length=20,
        widget=TextArea, help_text=_("Shorter Share"))
    description = forms.CharField(max_length=4096, min_length=0, 
        widget=TextArea, help_text=_("Long message to share."))
    url = forms.URLField()
    ...
    image_url_description = forms.CharField(max_length=4096, widget=TextArea)
